...
const Slider = () => {
    return (
      ...
      <div id="slide1" className="carousel-item relative w-full">
        <img src={slider1} className="w-full rounded-b-lg " />
        <div className="absolute rounded-b-lg  flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
      ...
      <div id="slide2" className="carousel-item relative w-full">
        <img src={slider2} className="w-full rounded-b-lg " />
        <div className="absolute rounded-b-lg  flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
        <div className="text-white space-y-7 pl-12 w-1/2">
            <h2 className="text-4xl font-bold">
            "Unlock Your Global Potential: Learn a New Language with Us!"
      ...
      <div id="slide3" className="carousel-item relative w-full">
        <img src={slider3} className="w-full rounded-b-lg " />
        <div className="absolute rounded-b-lg  flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
        <div className="text-white space-y-7 pl-12 w-1/2">
            <h2 className="text-4xl font-bold">
            "Unlock Your Global Potential: Learn a New Language with Us!"
      ...
      <div id="slide4" className="carousel-item relative w-full">
        <img src={slider4} className="w-full rounded-b-lg " />
        <div className="absolute rounded-b-lg  flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
        <div className="text-white space-y-7 pl-12 w-1/2">
            <h2 className="text-4xl font-bold">
            "Unlock Your Global Potential: Learn a New Language with Us!"
