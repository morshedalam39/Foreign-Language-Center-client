      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3  gap-6 mt-16 ">
        {instractor?.map((i) => (
          ...
          >
            <img
              alt=""
              className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-gray-500 transition-transform duration-300 transform hover:scale-110"
              src={i.image}
            />
            <div className="flex-1 my-4">
              ...
              <p className=" font-medium text-base">Email: {i.email}</p>
              <p className=" font-medium text-base">Number Of Student: {i.enroll}</p>
            </div>
            <hr className="w-64 mt-2 border-2 mx-auto border-b-stone-800" />
