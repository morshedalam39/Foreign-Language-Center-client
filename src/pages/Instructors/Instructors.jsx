...
//   console.log(instructor);
  return (
    <div className="grid md:grid-cols-2 lg:grid-cols-3  gap-6 mt-6">
      {instructor?.map((i) => (
       			<div key={i._id} className="flex flex-col justify-center w-full px-8 mx-auto my-12 text-center rounded-md md:w-80 shadow-2xl dark:bg-gray-100 dark:text-gray-800">
             <img alt="" className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-gray-500" src={i.image} />
             <div className="flex-1 my-4">
               <p className="text-xl font-semibold leading-snug">Name: {i.name}</p>
               <p>Email: {i.email}</p>
             </div>
